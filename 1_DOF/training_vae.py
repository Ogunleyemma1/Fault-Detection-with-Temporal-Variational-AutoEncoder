...
from structure1DOF import get_system_matrices, system_config, get_force_function  # Updated to import system config and force
...
def train_vae():
    ...
    for epoch in range(n_epochs):
        ...
        lambda_phys = min(1.0, epoch / 10.0)
